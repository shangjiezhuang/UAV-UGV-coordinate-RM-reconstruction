    ...
    for ep in range(num_episodes):
        ...
        for step in range(max_steps):
            ...
            action_data = policy.get_actions(
                ...
                uav_action_mask=obs["uav_action_mask"][np.newaxis],
            ...
            step_r_uav_progress.append(info.get("r_uav_progress", 0))
            step_r_ugv_progress.append(info.get("r_ugv_progress", 0))
            step_r_goal_arrival.append(info.get("r_goal_arrival", 0))
            step_r_revisit.append(info.get("r_revisit", 0))
            step_r_terminal.append(info.get("r_terminal", 0))
            step_nmse.append(info.get("nmse", 0))
            step_nmse_target_gap.append(info.get("nmse_target_gap", 0))
            step_target_gap_penalty_diag.append(info.get("target_gap_penalty_diag", 0))
            step_target_nmse.append(info.get("target_nmse", 0))
            ...
            ep_r_uav_progress += info.get("r_uav_progress", 0)
            ep_r_ugv_progress += info.get("r_ugv_progress", 0)
            ep_r_goal_arrival += info.get("r_goal_arrival", 0)
            ep_r_revisit += info.get("r_revisit", 0)
            ep_r_terminal += info.get("r_terminal", 0)
            ep_target_gap_penalty_diag += info.get("target_gap_penalty_diag", 0.0)
        ...
        all_nmse_target_gap.append(info.get("nmse_target_gap", 0.0))
