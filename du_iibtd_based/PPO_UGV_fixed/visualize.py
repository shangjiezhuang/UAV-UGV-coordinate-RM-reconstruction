...
def plot_planner_trajectory_2d_gif(
    ...
    def _update(frame_idx: int):
        ...
        mode_text.set_text(
            ...
            f"GlobalLeft={_format_int(planner_global_steps_remaining[frame_idx])}\n"
            f"LocalCand={_format_int(planner_local_candidate_count[frame_idx])}/"
            f"{_format_int(planner_local_candidate_threshold[frame_idx])}  "
            f"{switch_text}"
        )
