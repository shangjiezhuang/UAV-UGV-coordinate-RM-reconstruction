...
class UAVUGVEnvironment:
    ...
    def _setup_observation_spaces(self) -> None:
        ...
        #    + queue(1) + nmse(1) + bw_ratio(1) + los_link(1) + planner_state(5)
    ...
    def _sample_packet_bits(self, sample: SpectrumSample) -> float:
        ...
        return float(observed_band_count) * float(self.config.comm.data_per_sample)

    def _enqueue_sample_packet(self, sample: SpectrumSample, novelty_ratio: float = 1.0) -> float:
        data_size = self._sample_packet_bits(sample)
