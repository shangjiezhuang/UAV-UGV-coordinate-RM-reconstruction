...
class UAVUGVEnvironment:
    ...
    def _setup_observation_spaces(self) -> None:
        ...
        #    + current UGV building clearance(1)
        #    + quant/uncertainty features + pending ensemble progress
        #    + planner_state(5)
        ...
        if force_ensemble:
            ...
            if cached_outputs is not None:
                ...
                keep_ratio_t = adaptive_keep_ratio(
                    ...
                    late_ratio=max(0.05, float(self.config.planner.ensemble_keep_ratio) - 0.10),
                    switch_M=20,
                )
                ...
                try:
                    mean_map, var_map, _ = ensemble_reconstruct_maps(
                        ...
                        member_observation_mode=self.config.planner.ensemble_observation_mode,
    ...
    def _build_critic_state(
        ...
        parts.append(self._extract_uav_quant_unc_features(current_target=current_target))
        parts.append(np.array([self._pending_ensemble_norm()], dtype=float))
