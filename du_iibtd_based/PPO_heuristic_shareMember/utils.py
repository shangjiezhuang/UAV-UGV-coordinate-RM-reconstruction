...
def evaluate_policy(
    ...
    for ep in range(num_episodes):
        ...
        for step in range(max_steps):
            ...
            decoded_uav_action = env._decode_uav_action(uav_action)
            if len(decoded_uav_action) == 3:
                uav_direction, uav_bw_choice_idx, uav_quant_choice_idx = decoded_uav_action
            else:
                uav_direction, uav_bw_choice_idx = decoded_uav_action
