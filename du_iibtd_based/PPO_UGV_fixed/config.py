...
class UAVConfig:
    ...
    step_size: int = 4                            # Movement distance per action grid;
...
class RewardConfig:
    ...
    lambda_spatial_revisit: float = 0.8          # Bounded penalty for low-novelty spatial revisits
